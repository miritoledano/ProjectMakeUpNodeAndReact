...
export const Footer = () => {
  ...
  return (
   ...
   <footer id="footer">
    ...
    <img  id="img" src="/fLogo.png"/>
    <div id='accessibility'>
    <LuAccessibility size={30}/>
    <RxAccessibility size={30}/>
    </div>
    ...
    <div id='allicon' >
    <p id='cotert'> Contact us at:</p>
<div id='allicon2'>
      <div >
    <p className='p'>phon</p>
    <TiPhone size={80} />
    </div>
    <div>
...
<div class='social-links'>
    ...
    <div id="winnings">
    <p className="footer-text">© 2023 All Rights Reserved. Design by miri&shira</p>
    </div>
    </footer>
    </>
  );
